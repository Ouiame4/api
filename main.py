...
<h1 style='text-align: center;'>📊 Rapport d'Analyse de Veille Médiatique</h1>
<div style="text-align: center; margin-bottom: 30px;">
    <p>
        Ce rapport présente une analyse approfondie des données issues de la veille médiatique.
        Il fournit des indicateurs clés, des visualisations temporelles et sémantiques,
        ainsi qu’une synthèse des auteurs les plus actifs sur la période étudiée.
    </p>
</div>
